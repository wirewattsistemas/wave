<div class="p-8">
    ...
    @php
        ...
        $miembros = $miembro->beneficiarios(auth()->user());
...
<div class="flex justify-end w-full">
			<a  href="miembros.profile?id=0"   class="flex self-end justify-center w-auto px-4 py-2  text-sm font-medium text-white transition duration-150 ease-in-out border border-transparent rounded-md bg-wave-600 hover:bg-wave-500 focus:outline-none focus:border-wave-700 focus:shadow-outline-wave active:bg-wave-700" dusk="update-profile-button">
